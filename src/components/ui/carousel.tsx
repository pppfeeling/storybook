...
const CarouselDotList = React.forwardRef<
  HTMLButtonElement,
  React.ComponentProps<typeof Button>
>(({ className, variant = "ghost", size = "icon", ...props }, ref) => {
  ...
  return (
    <div className="flex flex-row align-middle justify-center gap-2 py-2">
      {scrollSnaps.map((_, index) => (
        <Button
          key={index}
          variant={index === selectedIndex ? "ghost" : "outline"}
          size={size}
...
CarouselDotList.displayName = "CarouselDotList";
